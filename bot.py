...
movies = {
    ...
    "058": {
        ...
        "country": "США, Канада",
        "director": "Джон Фавро",
        "genres": ["фантастика", "боевик", "семейный"]    
    },
    "059": {
    ...
    "067": {
        ...
        "genres": ["фантастика", "боевик", "комедия", "семейный"]    
    },
    "068": {
    ...
    "094": {
        "title": "Горничная",
        "year": 2025,
        "video": "BAACAgIAAxkBAAIcv2njnp6kuPbU3m8jhC7XYcojMNwMAAIZnQAC6cgZSzWNtbHSG-y2OwQ",
    ...
    "109": {
        ...
        "year": 2006,
        "video": "BAACAgIAAxkBAAIgimnsmcgSVQAB0VGoh5-7CaTL0RD7LgACp5YAAjsVYUvk0nf5SyuvTzsE",
        "description": "Надежды ученика пятого класса Джесса Аарона стать самым быстрым бегуном в классе разбились после того, как новичок Лесли Берк одержала победу в соревнованиях. Оснований для враждебности по отношению друг к друг у Джесса и Лесли более чем достаточно, и тем не менее между ними завязывается дружба. Как тут не подружиться, если приходится быть королем и королевой в обнаруженном в лесу волшебном царстве?",
        "country": "США",
        "director": "Габор Чупо",
    ...
    "110": {
        ...
        "year": 1999,
        "video": "BAACAgIAAxkBAAIiK2nxQjnkambIGTt23SkQmZ1Y2PrHAAJcogACE9CJS_0_EDko_6K5OwQ",
    ...
    "111": {
        ...
        "description": "12-летний Мигель живёт в мексиканской деревушке в семье сапожников и тайно мечтает стать музыкантом. Тайно, потому что в его семье музыка считается проклятием. Когда-то его прапрадед оставил жену, прапрабабку Мигеля, ради мечты, которая теперь не даёт спокойно жить и его праправнуку. С тех пор музыкальная тема в семье стала табу. Мигель обнаруживает, что между ним и его любимым певцом Эрнесто де ла Крусом, ныне покойным, существует некая связь. Паренёк отправляется к своему кумиру в Страну Мёртвых, где встречает души предков.",
        "country": "США, Мексика",
        "director": "Ли Анкрич и др.",
        "genres": ["семейный", "мультфильм", "фантастика"]    
    },
    "112": {
        "title": "Аладдин",
        "year": 1992,
        "video": "BAACAgIAAxkBAAIiJWnxQJPzdRRsOCp2GXMsayI3lZ4UAAJVogACE9CJS_oe55pN3D9BOwQ",
    ...
    "113": {
        "title": "Аладдин",
        "year": 2019,
        "video": "BAACAgIAAxkBAAIiJ2nxQStALZkEFl3YNpajMRgG53ZnAAJZogACE9CJS3gCG2DA1GuvOwQ",
        ...
        "country": "США, Великобритания",
        "director": "Гай Ричи",
        "genres": ["семейный", "фантастика"]    
    },
    "114": {
        "title": "ВАЛЛ-И",
        "year": 2008,
        "video": "BAACAgIAAxkBAAIiI2nxQBJLy0mlAaN6x8uXM49jRjc1AAJTogACE9CJS63Zy3Jh7nSLOwQ",
    ...
    "115": {
        ...
        "country": "США",
        "director": "Роб Минкофф, Роджер Аллес",
        "genres": ["семейный", "мультфильм", "фантастика"]    
    },
    "116": {
        "title": "Король Лев",
        "year": 2019,
        "video": "BAACAgIAAxkBAAIiKWnxQaz419RDmnQf3tglTZTSiLq7AAJaogACE9CJSyymGV0DRAirOwQ",
        "description": "Ремейк мультфильма 1994 года. У величественного Короля-Льва Муфасы рождается наследник по имени Симба. Уже в детстве любознательный малыш становится жертвой интриг своего завистливого дяди Шрама, мечтающего о власти. Симба познаёт горе утраты, предательство и изгнание, но в конце концов обретает верных друзей и находит любимую. Закалённый испытаниями, он в нелёгкой борьбе отвоёвывает своё законное место в «Круге жизни», осознав, что значит быть настоящим Королём.",
        "country": "США, Великобритания, Кения",
        "director": "Джон Фавро",
        "genres": ["семейный", "фантастика"]    
    },
    "117": {
        ...
        "genres": ["аниме", "мультфильм", "мелодрама", "драма"]    
    },
    "118": {
        "title": "Унесённые призраками",
        "year": 2001,
        "video": "BAACAgIAAxkBAAIim2nx4RLknEc2_nmRSPxnLqxQ8IO5AAIsmwACzDeRS6bXr-b-ZUewOwQ",
    ...
    "119": {
        "title": "Она мужчина",
        "year": 2006,
        "video": "BAACAgIAAxkBAAIit2nyFECWtqM_78eG1yN9X1jumb1eAAJFnQACzDeRS8-FeQABWPhdeDsE",
        "description": "17-летняя Виола играет в футбол лучше, чем любой мальчишка. Когда футбольные тренировки для девушек отменяются, она решается на отчаянный шаг - выдает себя за брата-близнеца Себастьяна. Живя в образе юноши, Виола влюбляется в своего соседа по комнате Дюка, который в свою очередь влюблен в студентку Оливию, а Оливия очарована Виолой, не зная, что она девушка. В день решающей игры Виоле остается одно: доказать, что она – настоящий мужчина. По крайней мере, на футбольном поле…",
        "country": "США, Канада",
    ...
    "123": {
        ...
        "year": 2003,
        "video": "BAACAgIAAxkBAAIkr2n2HHNlVuR8_sRnu-MDsdoc-YvMAAKDlgACe9CwS6zqrxd7Sgf2OwQ",
        "description": "Завоевав Гарвард, Элли Вудс занимает теперь должность юриста в крупной фирме и совмещает успешную карьеру с подготовкой к свадьбе. Пока не узнаёт, что мамочку её любимого пёсика Великана используют для опытов в косметической промышленности клиенты её же фирмы. Элли поднимается на борьбу за права животных и… вылетает с работы. Конечно, она подавлена и возмущена, но её оптимизм остаётся при ней. Мисс Вудс отправляется в Вашингтон, чтобы взять дело в свои наманикюренные ручки.",
        "country": "США",
    ...
    "124": {
        "title": "Зелёная книга",
        "year": 2018,
        "video": "BAACAgIAAxkBAAInnWn7SQjFyfPrdBe6uzlFCTtaH0WwAAJCoAACBavhS3N_fNLyXhcTOwQ",
        ...
        "country": "США, Китай",
        "director": "Питер Фаррели",
        "genres": ["драма", "комедия", "биография"]    
    },
    "125": {
        "title": "Из моего окна",
        "year": 2022,
        "video": "BAACAgIAAxkBAAIoaGoE189-Cx54GoEZLgVs9_CgvM3jAAKjmAACZKcpSHVDcOoF0irpOwQ",
    ...
    "126": {
        "title": "После",
        "year": 2019,
        "video": "BAACAgIAAxkBAAIpxWoPmzIYLJnMJlYe5hDXTobmK27vAAJRnQAC4-15SCkp5HDYkIrXOwQ",
        ...
        "country": "США",
        "director": "Дженни Гейдж",
        "genres": ["мелодрама"]    
    },
    "127": {
        "title": "После. Глава 2",
        "year": 2020,
        "video": "BAACAgIAAxkBAAIpw2oPmm5AFcJbbUUeG6SAdiTk4iZJAAJQnQAC4-15SKnbOm-V4VfGOwQ",
        "description": "Встреча с Хардином разделила её жизнь на до и после. Молодые и такие разные – от их страсти буквально разлетаются искры. Однако внезапно в жизни девушки появляется новый знакомый, который готов положить к её ногам весь мир.",
        "country": "США",
        "director": "Роджер Камбл",
        "genres": ["мелодрама"]    
    },
    "128": {
        "title": "После. Глава 3",
        "year": 2021,
        "video": "BAACAgIAAxkBAAIpyWoPnKdj4wLvv422PHrDrspGx26VAAJZnQAC4-15SDotm9yIMfEOOwQ",
        "description": "Встреча с притягательным бунтарем Хардином разделила жизнь Тессы на «до» и «после». Их судьбы кажутся неразрывно связанными, но Тесса сталкивается со сложным выбором: согласиться на работу мечты в крупном издательстве или переехать в Лондон вместе с Хардином. Их страстную любовь ждет проверка на прочность: тайны прошлого, новые секреты и ответ на вопрос, что они на самом деле значат друг для друга…",
        "country": "США, Болгария",
        "director": "Кастиль Лэндон",
        "genres": ["мелодрама"]    
    },
    "132": {
        "title": "Обсессия",
        "year": 2025,
        "video": "BAACAgIAAxkBAAItV2pGUrUoXYljNXPwPYU6QZQ9AAFCwQACcaoAAszGOUoeGl8yGC6zdjwE",
        "description": "Безнадежный романтик Беар давно и безответно влюблён в красавицу Никки. Однажды в магазине эзотерики он находит странную безделушку — волшебную палочку. Если её сломать, исполнится твоё заветное желание. Беар загадывает, чтобы Никки любила его больше всех на свете. И вот чудо — девушка и правда в него влюбляется. Однако его счастью быстро приходит конец — Ники буквально им одержима, а её знаки внимания становятся всё более пугающими. Оказывается, желание парня исполнилось, но совсем не так, как он мечтал.",
        "country": "США",
    ...
    "133": {
        "title": "Дракула",
        "year": 2014,
        "video": "BAACAgIAAxkBAAItrGpLiHrHSx3K5tn172CAUsZ7vU2AAALflAACBiZhSjaCXwFU7tBsPAQ",
        "description": "Влад Дракула был величайшим правителем, доблестным воином и страстным мужчиной. Но судьба свела его с врагом, коварство которого не знало границ. И тогда Дракула заключил сделку – нечеловеческая сила в обмен на самую малость – бессмертную душу…",
        "country": "США, Япония",
        "director": "Гари Шор",
        "genres": ["ужасы", "боевик", "фантастика", "драма"]    
    },
    "134": {
        "title": "Дракула",
        "year": 2025,
        "video": "BAACAgIAAxkBAAItrmpLiM5r1bIjfsMlw_XWCyi3tGxrAALnlAACBiZhSuybl0fBlH1oPAQ",
        ...
        "country": "Франция",
        "director": "Люк Бессон",
        "genres": ["ужасы", "мелодрама", "драма"]    
    },
    "135": {
        "title": "Бойцовский клуб",
        "year": 1999,
        "video": "BAACAgIAAxkBAAIts2pLj9dMlqMZF5R0mQcPEt3MQ5SEAAJJlQACBiZhSkQK_vPC7dJCPAQ",
    ...
    "136": {
        "title": "Царство",
        "year": 2019,
        "video": "BAACAgIAAxkBAAItuWpLkL2niV1oGZq4bDa6sRmTDoGRAAJYlQACBiZhSq-ckCqwq8BTPAQ",
        "description": "III век до н. э., период Сражающихся царств, когда на территории современного Китая было множество постоянно воевавших друг с другом небольших государств. Где-то на задворках одного из таких царств двое сирот Синь и Пяо ежедневно тренируются, чтобы исполнить свою мечту стать великими генералами. Но один из друзей оказывается поразительно похож на правителя, и парня забирают во дворец в качестве его двойника. Вскоре окровавленный Пяо приползёт умирать к лачуге Синя, и тот, вне себя от ярости, тут же отправится мстить убийцам друга.",
        "country": "Япония",
        "director": "Синсуке Сато",
        "genres": ["боевик", "драма"]    
    },
    "137": {
        "title": "Царство 2: В далекие края",
        "year": 2022,
        "video": "BAACAgIAAxkBAAItu2pLkP7Vhslf3rFp7qIC3h2n1UI3AAJblQACBiZhSiIJF8XFBjknPAQ",
        "description": "245 год до н. э. На правителя царства Цинь прямо во дворце совершается нападение, но вовремя появившийся Ли Синь расправляется с убийцами. Вскоре приходит тревожная весть — войска государства Вэй пересекли границу, а значит грядёт большая битва. Синь отправляется на войну в составе регулярных войск, где встречает загадочного воина по имени Цян Лэй.",
        "country": "Япония",
        "director": "Синсуке Сато",
        "genres": ["боевик", "драма"]     
    },
    "138": {
        "title": "Царство 3: Пламя Судьбы",
        "year": 2023,
        "video": "BAACAgIAAxkBAAItvWpLkTwS6K2ozpCG-3HjU3eRcg6HAAJelQACBiZhStd8c8vrw8PvPAQ",
        "description": "После победы на равнинах Ли Синь тренировался под началом своего кумира — генерала Ван Ци. Пока правитель Ин Чжэн мечтает об объединённом Китае, на Цинь нападают войска Чжао и уничтожают население целого города. Чтобы противостоять им в численности, в армию добирают крестьян, а значит решающее значение будет иметь стратегия. Советник предлагает кандидатуру Ван Ци, а у того в грядущей битве для Ли Синя приготовлена особая роль.",
        "country": "Япония",
        "director": "Синсуке Сато",
        "genres": ["боевик", "драма"]       
    },
...
series = {
    ...
    "130": {
        ...
        "poster": "AgACAgIAAxkBAAIrkmohzyyCE-LEAAFPhX7J7OvhglLx4QACPiBrGwWVEEk-IufbeRMJTwEAAwIAA3gAAzsE",
        "country": "США",
